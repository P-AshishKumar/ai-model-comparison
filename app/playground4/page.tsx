      ...
      <main className="flex-grow container mx-auto py-12 px-4 max-w-4xl">
        ...
        <article className="prose prose-invert prose-lg max-w-none">
          ...
          <div className="mb-8 text-gray-300">
            <p>In this exercise, we'll use GitHub Copilot to build an application similar to Jupyter notebook extension that integrates with Large Language Models. The extension will allow users to interact with C   hatGPT LLMs directly from their notebooks, execute code generated by the models, and maintain context between cells.</p>
          </div>
