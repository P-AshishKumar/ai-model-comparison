...
export default function Playground4Page() {
  ...
  const resources = [
    ...
    { name: "GitHub Copilot Docs", url: "https://docs.github.com/en/copilot", icon: <Github className="h-4 w-4 mr-2" /> },
  ...
  const promptBlocks = [
    {
      ...
      prompt: "This sample code demonstrates how to use the OpenAI API. First, import the OpenAI library and initialize a client. Then, create a chat completion by calling the client.chat.completions.create() method with your chosen model (in this case 'gpt-4o') and a messages array containing the user's prompt. Finally, print the response content by accessing completion.choices[0].message.content. This code needs to be integrated into LLMNotebook.py at lines 32-54.",
    },
    {
      number: 2,
      title: "API Key Configuration",
      prompt: "How to provide the OpenAI key for my API",
    },
    {
      number: 3,
      title: "Debugging Code Execution",
      prompt: "The notebook cell we created is not working and fails to execute the code provided. Please modify it to properly execute the commands being passed from the notebook input cell.",
    },
    {
      number: 4,
      title: "Improving Context Awareness",
    ...
    {
      number: 5,
      title: "Improving UI Experience",
      prompt: "When clicking the \"Get Assistance\" button, the code output disappears. I'd like the output to remain visible until I click \"Run Code\" again.",
    },
  ];
      ...
      <main className="flex-grow container mx-auto py-12 px-4 max-w-4xl">
        ...
        <article className="prose prose-invert prose-lg max-w-none">
          <h1 className="text-2xl font-bold mb-1 bg-clip-text text-transparent bg-gradient-to-r from-indigo-300 to-blue-200">
            Building an LLM-Powered Jupyter Notebook
          </h1>
          
          <div className="mb-8 text-gray-300">
            <p>In this exercise, we'll use GitHub Copilot to build a Jupyter notebook extension that integrates with Large Language Models. The extension will allow users to interact with various LLMs directly from their notebooks, execute code generated by the models, and maintain context between cells.</p>
          </div>
